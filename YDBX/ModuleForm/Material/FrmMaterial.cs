    ...
    public partial class FrmMaterial : Form
    {
        ...
        private void GetMaterialData(string sKey)
        {
            try
            {
                string SqlStr = string.Format(@"SELECT a.material_id,a.[Material_Code],a.[Material_Name],a.Material_Type_Name,a.Material_Spec,Material_Unit,a.Remark,
                                                Convert(Varchar(100),a.Creation_Date,120) Create_Time ,a.Created_By,Convert(Varchar(100),a.Last_Update_Date,120) Modify_Time ,a.Last_Updated_By,a.Material_Image
        ...
        private void btn_Edit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                PlanForm.sMPicture = dgvCommon.Rows[dgvCommon.CurrentRow.Index].Cells["Material_Image"].Value.ToString();
