...
namespace Monitor
{
    public partial class FrmGridding4 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            lbl_NO.BackColor = System.Drawing.Color.FromArgb(16,16,16);
            ...
            if (lbl_Number.Text.ToString().Trim().Length != 0 && TheoryQty >= 0)//理论数量最好不小于100
            {
                ...
                else
                {
                    timer2.Stop();
                    bool flag = timer2.Enabled;
                    lbl_Number.BackColor = System.Drawing.Color.FromArgb(16,16,16);
