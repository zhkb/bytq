...
namespace Report
{
    public partial class FrmPRQualityInfoReport : Form
    {
        private DataSet MasterDataSet = null;
        public FrmPRQualityInfoReport()
        {
            InitializeComponent();
        }
        ...
        private void FrmPRQualityInfoReport_Load(object sender, EventArgs e)
        {
        ...
        private void LoadData(string startTime, string endTime, string sKey)
        {
            try
            {
                string SqlStr = string.Format(@"SELECT [Product_BarCode]
                                                  ...
                                                  ,CASE WHEN(Check_Result = 0) THEN 'NG' WHEN(Check_Result = 1) THEN 'OK' ELSE 'NG' END AS Check_Result
                ...
                //倒序排序
                string sOrder = " order by Scan_Time  ";
        ...
        private void btn_print_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (table != null && table.Rows.Count > 0)
                {
                    ...
                    report.Load(Application.StartupPath + @"\Report\Info_Report_quality.frx");
            ...
            {
                SysBusinessFunction.WriteLog("安检信息打印出错," + ex.Message);
                SysBusinessFunction.SystemDialog(SysBusinessFunction.DialogOKMessage, "安检信息打印出错");
            }
        }
    }
}
