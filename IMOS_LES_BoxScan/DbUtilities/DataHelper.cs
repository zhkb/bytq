...
namespace Sys.DbUtilities
{
    ...
    public class DataHelper
    {
        ...
        public static int ExecuteProcedure(string procedureName, OracleParameter[] dbParameters)
        {
            return NewOracleHelper.ExecuteCommand(OracledbConn, CommandType.StoredProcedure, procedureName, dbParameters);
        }
    }
}
