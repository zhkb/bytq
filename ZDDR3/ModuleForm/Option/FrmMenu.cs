    ...
    public partial class FrmMenu : Form
    {
        ...
        public void GetMenuParamData()
        {
            try
            {
                ...
                string SqlStr = string.Format(@"select a.Menu_ID, a.Menu_Code, a.Menu_Name, a.Menu_Sort, a.Remark, 
        ...
        public void GetModuleParamData(string sMenuCode)
        {
            ...
            {
                DataSet DBDataSet = new DataSet();
                string SqlStr = string.Format(@"SELECT A.Module_ID, A.Module_Code, A.Module_Name, A.Module_Source, A.Module_Form, A.Module_Sort, A.Remark, 
