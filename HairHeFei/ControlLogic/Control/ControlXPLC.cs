...
namespace ControlLogic.Control
{
    ...
    public class ControlXPLC
    {
        ...
        public static void SystemInitialization()
        {
            ...
            {
                MasterPLC_Mitsubishi.ActLogicalStationNumber = int.Parse(BaseSystemInfo.MasterPLCStation_Sencond);
                MasterPLCPLCConn = MasterPLC_Mitsubishi.Open();

            }
            else if (BaseSystemInfo.PLCType == "2") // 西门子PLC
            {
                MasterPLC_Siemens.PLCConnectionIP = BaseSystemInfo.MasterPLCIP_Sencond;
        ...
        public static void PLCReConnect(object o)
        {
            ...
            {
                SysBusinessFunction.WriteLog("二楼 PLC重连失败." + ex.Message);
            }
            finally
            {
