    ...
    public partial class FrmPassWord : BaseForm
    {
        ...
        private void btn_OK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql = string.Format(@" select * from Sys_User where User_ID='{0}'and User_PassWord='{1}'", BaseSystemInfo.CurrentUserID, PassWord);
                ...
                string Updatesql = string.Format(@"Update Sys_User Set User_PassWord = '{0}' Where User_ID='{1}'", NewPassWord, BaseSystemInfo.CurrentUserID);
