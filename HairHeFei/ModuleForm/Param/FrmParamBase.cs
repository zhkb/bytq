    ...
    public partial class FrmParamBase : Form
    {
        ...
        private void GetHeadList()
        {
            ...
            string SqlStr = string.Format(@"select a.Parameter_Master_ID, a.Parameter_Master_Code, a.Parameter_Master_Name, a.Remark,
                                            ...
                                            from Sys_Parameters_Master a left join Sys_User b on (a.Company_Code = b.Company_Code and a.Factory_Code = b.Factory_Code and a.product_line_code = b.Product_Line_Code and  a.Created_By = b.User_ID)
                                            left join Sys_User c on (a.Company_Code = c.Company_Code and a.Factory_Code = c.Factory_Code and a.product_line_code = c.Product_Line_Code and  a.Last_Updated_By = c.User_ID)
                                            where a.Company_Code='{0}'and a.Factory_Code='{1}' and a.product_line_code='{2}'
                                            ORDER BY a.Parameter_Master_Code", BaseSystemInfo.CompanyCode, BaseSystemInfo.FactoryCode, BaseSystemInfo.ProductLineCode);
        ...
        private void GetDetailList(string sCodeNo)
        {
            ...
            string SqlStr = string.Format(@"select a.Parameter_Detail_ID, a.Parameter_Detail_Code, a.Parameter_Detail_Name, a.Remark,
                                          Convert(varchar(20),a.Creation_Date,120)Creation_Date, b.User_Name Create_User_Name, 
                                          Convert(varchar(20),a.Last_Update_Date,120)Last_Update_Date, c.User_Name Edit_User_Name
                                          from Sys_Parameters_Detail a left join Sys_User b on (a.Company_Code = b.Company_Code and a.Factory_Code = b.Factory_Code and a.product_line_code = b.Product_Line_Code and  a.Created_By = b.User_ID)
                                          left join Sys_User c on (a.Company_Code = c.Company_Code and a.Factory_Code = c.Factory_Code and a.product_line_code = c.Product_Line_Code and  a.Last_Updated_By = c.User_ID)
                                          where a.Company_Code='{0}'and a.Factory_Code='{1}' and a.product_line_code='{2}' and Parameter_Master_Code='{3}'
                                          ORDER BY a.Parameter_Detail_Code", BaseSystemInfo.CompanyCode, BaseSystemInfo.FactoryCode, BaseSystemInfo.ProductLineCode, sCodeNo);
