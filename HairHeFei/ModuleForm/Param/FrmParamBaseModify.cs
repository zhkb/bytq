    ...
    public partial class FrmParamBaseModify : Form
    {
        ...
        private void btn_Ok_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                string sSQLCheck = string.Format(@"select * from Sys_Parameters_Master 
                                                   where Company_Code='{0}'and Factory_Code='{1}' and product_line_code='{2}' 
                                                   and  Parameter_Master_Name = '{4}' and Parameter_Master_Code != '{5}'",
            ...
            try
            {
                ...
                else//修改类型记录
                {
                    ...
                    string DetailSqlStr = string.Format(@"UPDATE dbo.Sys_Parameters_Detail 
                                                    SET Parameter_Master_Name = '{0}'
                                                    WHERE Parameter_Master_Code = {1}", sCodeName, sCodeNo);
                    DataHelper.Fill(DetailSqlStr);
